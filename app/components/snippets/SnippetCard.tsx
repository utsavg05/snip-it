...
export default function SnippetCard({
  ...
  return (
    ...
    //     <div className="flex items-center gap-2 text-xs">
    //       {/* Language badge */}
    //       <span className="rounded-lg bg-emerald-500/10 border cursor-default border-emerald-500/20 px-2.5 py-1 font-mono text-[11px] sm:text-xs tracking-wide text-emerald-400 font-semibold">
    //         {language}
    //       </span>
