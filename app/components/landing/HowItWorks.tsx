    ...
    >
      <div className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-md md:text-lg leading-5.5 md:leading-relaxed text-neutral-400">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {/* Step 1 */}
          <div className="group rounded-2xl border border-white/10 bg-white/5 p-5 md:p-8 transition hover:border-emerald-400/30 hover:bg-white/[0.08]">
            <span className="mb-5 inline-flex h-10 w-10 items-center justify-center rounded-full bg-emerald-500/20 text-base font-bold text-emerald-400">
              1
            </span>
            ...
            <p className="text-sm md:text-base leading-5 md:leading-relaxed text-neutral-400">
